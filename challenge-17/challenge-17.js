(function () {
	...
	*/
	...
	console.log( text.replace(/Manuel Marques de Sousa/g, 'Orlando Linhares da Silva') ) ;
	...
	*/
	...
	var mesUser = 'março'
	console.log('O mês de '+mesUser+' é representado pelo número '+getMonthNumber(mesUser) +'.')

	var mesUser = 'setembro'
	console.log('O mês de '+mesUser+' é representado pelo número '+getMonthNumber(mesUser) +'.')

	var mesUser = 'dezembro'
	console.log('O mês de '+mesUser+' é representado pelo número '+getMonthNumber(mesUser) +'.')
	...
	*/
	...
	//deixar a função apartada
	console.log( text.replace(regexDate, function replaceDate(capturaTotal, dia, mes, ano) { 
