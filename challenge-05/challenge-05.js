...
*/
array2 = [1, '1', null, {}, function teste() {}]
...
function book (nomeLivro) {
	var obj = { 
			'livro1': {
				quantidadePaginas:10, autor:'Paulo Coelho', editora:'Abril'
			}, 
			'livro2': {
				quantidadePaginas:11, autor:'Paulo Coelho', editora:'Abril'
			}, 
			'livro3': {
				quantidadePaginas:12, autor:'Paulo Coelho', editora:'Abril'
			} 
		};
