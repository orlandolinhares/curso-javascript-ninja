( function () { 
	...
	*/
	...
	brasil.unshift( 'Pará', 'Amazonas', 'Tocantins' );
	console.log( brasil );
	...
	*/
	var nordeste = ['Rio Grande do norte', 
					'Alagoas', 
					'Pernambuco', 
					'Bahia', 
					'Piauí', 
	...
	*/
	brasil = brasil.concat( nordeste ); //concat nao modifica o array, portanto é necessário atribuir.
